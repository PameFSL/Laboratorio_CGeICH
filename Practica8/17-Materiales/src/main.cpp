...
void applicationLoop() {
	...
	while (psi) {
		...
		glUniform3f(iluminacionShader.getUniformLocation("light.ambient"), 0.5, 0.5, 0.5);
		...
		glUniform3f(iluminacionShader.getUniformLocation("material.ambient"), 0.24725, 0.1995, 0.0745); //1.0 0.2, 0.6
		glUniform3f(iluminacionShader.getUniformLocation("material.diffuse"), 0.75164, 0.60648, 0.22648); // 0.4, 0.5, 0.8
		glUniform3f(iluminacionShader.getUniformLocation("material.specular"), 0.628281, 0.555802, 0.366065); //0.5, 0.3, 0.2
		glUniform1f(iluminacionShader.getUniformLocation("material.shininess"), 0.4 * 128.0); //64.0
